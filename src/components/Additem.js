...
class Additem extends Component {
  constructor(props) {
    ...
    this.rootRef = app.database().ref("shops/Shop Details/Star telecom/items/");
  ...
  handleSubmit(event) {
    ...
    var pri=Price;
    this.rootRef.child(Product).set({
        MRP:Mrp,
        ProductName: pro,
        ProductQuantity: qua,
        SellingPrice:pri
    ...
    return (
        ...
        {this.state.form &&
          ...
          <div className="col col-md-10 text-right">
            <button onClick={this.handleSubmit} type ="button" className="btn btn-secondary">
              +Add New
            </button>
